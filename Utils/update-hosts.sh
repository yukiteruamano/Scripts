...
HOSTS_PATH="$HOME/etc/hosts" # The path to the hosts file
INITIAL_HOSTS="$HOME/etc/hosts.initial" # The initial host file to be appended at the top of the hosts file
EXCLUDE_HOSTS="$HOME/etc/hosts.exclude" # A file containing a list of domain to be excluded from the hosts file (1 domain per line)
